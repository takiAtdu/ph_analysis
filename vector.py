...
plt.gca().set_aspect('equal')  # Set the aspect ratio of the figure
plt.scatter(x[labels == 1], y[labels == 1], c="r")  # Show 1-labled data by "r"ed
plt.scatter(x[labels == 2], y[labels == 2], c="b")  # Show 2-labled data by "b"lue
plt.scatter(x[labels == 3], y[labels == 3], c="g")  # Show 3-labled data by "b"lue
